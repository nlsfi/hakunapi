...
import fi.nls.hakunapi.html.HTMLMessageBodyWriter;
import fi.nls.hakunapi.html.OutputFormatHTML;
import fi.nls.hakunapi.simple.servlet.CacheManager;
import fi.nls.hakunapi.simple.servlet.CatchAllExceptionMapper;
import fi.nls.hakunapi.simple.servlet.CorsFilter;
import fi.nls.hakunapi.simple.servlet.GzipFilter;
import fi.nls.hakunapi.simple.servlet.GzipInterceptor;
import fi.nls.hakunapi.simple.servlet.NotFoundExceptionMapper;
import fi.nls.hakunapi.simple.servlet.ObjectMapperProvider;
import fi.nls.hakunapi.simple.servlet.operation.CollectionMetadataImpl;
import fi.nls.hakunapi.simple.servlet.operation.CollectionsMetadataImpl;
import fi.nls.hakunapi.simple.servlet.operation.ConformanceImpl;
import fi.nls.hakunapi.simple.servlet.operation.FunctionsMetadataImpl;
import fi.nls.hakunapi.simple.servlet.operation.GetCollectionItemByIdOperation;
import fi.nls.hakunapi.simple.servlet.operation.GetCollectionItemsOperation;
import fi.nls.hakunapi.simple.servlet.operation.GetCollectionQueryablesImpl;
import fi.nls.hakunapi.simple.servlet.operation.GetCollectionSchemaImpl;
import fi.nls.hakunapi.simple.servlet.operation.GetItemsOperation;
import fi.nls.hakunapi.simple.servlet.operation.LandingPageImpl;
import fi.nls.hakunapi.simple.servlet.operation.OpenAPI30ApiOperation;
