  ...
  <div class="container-lg py-4">
    <nav class="nav justify-content-between" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a class="d-flex align-items-center text-dark text-decoration-none" href="collections/${model.collectionId}${langQuery}">${model.collectionId}</a></li>
...
<#if availableLanguages?size gt 1>
    ...
    <header class="pb-2 mb-2">
      <h1 class="mb-0">${(model.title)!(model.collectionId)}</h1>
      <small class="text-secondary">${model.collectionId}</small>
